...
// Its own module so the eager TopBar can use it without pulling every
// formatter (and the date-fns functions only lazy pages need) onto the
// critical path. Re-exported: callers keep importing it from here.
