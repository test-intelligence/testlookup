...
MUTATIONS = (
    ...
    Mutation(
        "deprecation-client-version",
        "frontend/src/pages/TestManagementPage.tsx",
        "          expected_version: pendingDeprecation.version,\n",
        "",
        "frontend/src/pages/TestManagementPage.cases-errors.test.tsx",
    ),
    Mutation(
        ...
        "",
        "frontend/src/pages/TestManagementPage.reviews.test.tsx",
    ),
    Mutation(
        "plan-add-lock",
        "backend/app/services/test_management_service.py",
    ...
    Mutation(
        ...
        '    await audit_event(\n        db,\n        "test_plan_item",\n        item.id,\n        plan.project_id,\n        "added",\n',
        '    if False:\n        await audit_event(\n            db,\n            "test_plan_item",\n            item.id,\n            plan.project_id,\n            "added",\n',
        "backend/tests/test_exploratory_m16_test_management.py::test_adding_plan_membership_writes_attributable_audit",
    ),
    Mutation(
        "plan-remove-audit",
        "backend/app/services/test_management_service.py",
