"""CI-context auto-detection for the TestLookup Python SDK (US-4.3b).
...
Detection matrix (first match wins — mirrored byte-for-byte in the JS, Java,
and Go SDKs plus ``cli/testlookup_cli/ci_context.py``; keep all copies in
