...
Source: [backend/app/routers/onboarding.py:171](../../../backend/app/routers/onboarding.py#L171).
...
```python
event_name: Optional[str]=Query(None), project_id: Optional[str]=Query(None), limit: int=Query(100, ge=1, le=500), db: AsyncSession=Depends(get_db), current_user: User=Depends(require_role(UserRole.ADMIN))
```
...
```json
{
  "operationId": "list_usage_events_api_v1_onboarding_events_get",
  "parameters": [
    {
      "in": "query",
      "name": "event_name",
...
```python
await get_usage_events(db, event_name=event_name, project_id=pid, limit=limit)
```
...
Source: [backend/app/routers/onboarding.py:137](../../../backend/app/routers/onboarding.py#L137).
...
```python
body: TrackEventRequest, db: AsyncSession=Depends(get_db), current_user: User=Depends(get_current_active_user)
```
...
```json
{
  "operationId": "track_usage_event_api_v1_onboarding_track_post",
  "parameters": [
    {
      "in": "header",
      "name": "X-API-Key",
...
Source: [backend/app/routers/onboarding.py:80](../../../backend/app/routers/onboarding.py#L80).
...
```python
project_id: uuid.UUID, body: StepAction, db: AsyncSession=Depends(get_db), current_user: User=Depends(require_project_access())
```
...
HTTPException(status_code=500, detail='Failed to update step')
```
...
```json
{
  "operationId": "mark_step_complete_api_v1_onboarding__project_id__complete_post",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
Source: [backend/app/routers/onboarding.py:60](../../../backend/app/routers/onboarding.py#L60).
...
```json
{
  "operationId": "detect_progress_api_v1_onboarding__project_id__detect_post",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
```python
result
{'project_id': str(project_id), 'steps': [], 'completed_count': 0, 'total_count': 0, 'progress_pct': 0, 'is_complete': False}
```
...
Source: [backend/app/routers/onboarding.py:118](../../../backend/app/routers/onboarding.py#L118).
...
```python
project_id: uuid.UUID, body: StepAction, db: AsyncSession=Depends(get_db), _: User=Depends(require_project_access())
```
...
```python
HTTPException(status_code=422, detail=str(exc))
HTTPException(status_code=500, detail='Failed to restore step')
```
...
```json
{
  "operationId": "mark_step_restored_api_v1_onboarding__project_id__restore_post",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
Source: [backend/app/routers/onboarding.py:99](../../../backend/app/routers/onboarding.py#L99).
...
```python
HTTPException(status_code=422, detail=str(exc))
HTTPException(status_code=500, detail='Failed to skip step')
```
...
```json
{
  "operationId": "mark_step_skipped_api_v1_onboarding__project_id__skip_post",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
Source: [backend/app/routers/onboarding.py:43](../../../backend/app/routers/onboarding.py#L43).
...
```json
{
  "operationId": "get_status_api_v1_onboarding__project_id__status_get",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
```python
await get_onboarding_status(project_id, db)
{'project_id': str(project_id), 'steps': [], 'completed_count': 0, 'total_count': 0, 'progress_pct': 0, 'is_complete': False}
```
