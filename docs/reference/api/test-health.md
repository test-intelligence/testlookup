...
## GET `/api/v1/projects/{project_id}/flaky-coach`

Get Project Flaky Coach
...
```json
{
  "operationId": "get_project_flaky_coach_api_v1_projects__project_id__flaky_coach_get",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
  ...
  "responses": {
    "200": {
      "content": {
        "application/json": {
          "schema": {
            "$ref": "#/components/schemas/FlakyCoachResponse"
          }
        }
      },
...
```json
{
  "operationId": "refresh_project_flaky_coach_api_v1_projects__project_id__flaky_coach_refresh_post",
  "parameters": [
    {
      "in": "path",
      "name": "project_id",
...
```python
{'status': 'completed', 'flaky_tests_found': count}
```
...
## GET `/api/v1/runs/{run_id}/test-health`
...
```json
{
  "operationId": "get_test_health_api_v1_runs__run_id__test_health_get",
  "parameters": [
    {
      "in": "path",
      "name": "run_id",
