...
| REQ-08 | Enforce roles and separation of duties | API authorization ratchet, review service tests, review integration | CI | Browser role matrix is live-only beyond auth smoke |
| REQ-09 | Gate unreviewed AI narratives and actions | review-gate API/worker/notification/export tests | CI/live | Investigator excerpts still await a canonical review subject |
...
| REQ-16 | Make regressions measurable | backend and frontend coverage floors, quality guards, mutation checks | CI | MCP/CLI lack numeric coverage floors |
