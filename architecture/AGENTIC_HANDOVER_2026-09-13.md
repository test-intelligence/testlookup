...
| T4 | P1 | S | Fix K4: `mode=act` half of mutating-call invariant | `services/agent_action_ledger_service.py` | — | `tests/services/test_agent_action_ledger_service.py` | §12 E8.6 note |
...
| T12 | P0 for E5 promotion | M | **E9.1** EvalVerdict + recordings keyed by model@tier | `agent_eval_harness.py`, `eval_gate_service.py`, `prompt_registry.py`, `prompt_eval_recordings.py` | — | harness tests | AI_EVALUATION.md |
