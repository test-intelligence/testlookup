...
_SPECS = (
    ...
    _capability("defect_commander", inputs="AnalysisAgentOutput", output="DefectCommanderOutput", dependencies=("root_cause_analysis",), evidence=("analysis_findings",), concurrency_class="action_proposal", permission="mutating"),
    ...
    _capability("workflow", inputs="AgenticRunV1", output="WorkflowFailure", cost_usd=0, fallback="persist_terminal_failure", concurrency_class="runtime"),
)
